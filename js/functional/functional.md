...
**Declarative** - tell the computer what you want done by calling a method or function. JS offers many predefined methods that handled common tasks so you don't need to write out how the computer should perform them. E.g. Calling the "for" loop to iterate through an array, instead of calling the "map" function.
...
Window.prototype.tabClose = function (index) {
  ...
  bar tabsAfterIndex = this.tabs.slice(index + 1);
